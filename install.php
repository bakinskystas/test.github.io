...
INSERT INTO `blogs_categories` (`category_id`, `category_name`, `category_order`, `category_description`) VALUES
(1, 'Art', 1, ''),
(2, 'Causes', 2, ''),
(3, 'Crafts', 3, ''),
(4, 'Dance', 4, ''),
...
INSERT INTO `events_categories` (`category_id`, `category_name`, `category_order`, `category_description`) VALUES
(1, 'Art', 1, ''),
(2, 'Causes', 2, ''),
(3, 'Crafts', 3, ''),
(4, 'Dance', 4, ''),
...
INSERT INTO `groups_categories` (`category_id`, `category_name`, `category_order`, `category_description`) VALUES
...
INSERT INTO `jobs_categories` (`category_id`, `category_name`, `category_order`, `category_description`) VALUES
(1, 'Admin &amp; Office', 1, ''),
(2, 'Art &amp; Design', 2, ''),
...
INSERT INTO `market_categories` (`category_id`, `category_name`, `category_order`, `category_description`) VALUES
...
INSERT INTO `offers_categories` (`category_id`, `category_name`, `category_order`, `category_description`) VALUES
(1, 'Apparel &amp; Accessories', 1, ''),
(2, 'Autos &amp; Vehicles', 2, ''),
(3, 'Baby &amp; Children&#039;s Products', 3, ''),
(4, 'Beauty Products &amp; Services', 4, ''),
...
INSERT INTO `pages_categories` (`category_id`, `category_name`, `category_order`, `category_description`) VALUES
(1, 'Cars and Vehicles', 1, ''),
(2, 'Comedy', 2, ''),
(3, 'Economics and Trade', 3, ''),
(4, 'Education', 4, ''),
...
) ENGINE=InnoDB AUTO_INCREMENT=348 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;
...
(147, 'ftp_path', ''),
(148, 'ftp_endpoint', ''),
(149, 'session_hash', '4jm0ZhhZg-23mFa-4rWEB-3ChlO-4silK-9767c0066ae4'),
...
(334, 'invitation_type', 'email'),
(335, 'funding_enabled', '0'),
(336, 'funding_permission', 'everyone'),
(337, 'system_description_funding', 'Discover new funding requests'),
(338, 'stories_permission', 'everyone'),
(339, 'ads_permission', 'everyone'),
(340, 'paystack_enabled', '0'),
(341, 'paystack_secret', ''),
(342, 'funding_money_withdraw_enabled', '1'),
(343, 'funding_payment_method', 'paypal,skrill'),
(344, 'funding_payment_method_custom', ''),
(345, 'funding_min_withdrawal', '50'),
(346, 'funding_money_transfer_enabled', '0'),
(347, 'funding_commission', '10');
